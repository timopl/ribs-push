package com.example.ribpush.child.feature
...
import com.example.ribpush.child.feature.ChildFeature.Effect
...
internal class ChildFeature : ActorReducerFeature<Wish, Effect, State, News>(
    initialState = State(),
